...
list_of_peoples = []
number_of_peoples_1 = input ("Enter the number of value '")

for peoples in number_of_peoples_1:
    list_of_peoples.append (number_of_peoples_1)
    number_of_peoples_2 = input ("Enter the number of value '")
    list_of_peoples.append (number_of_peoples_2)
    number_of_peoples_3 = input ("Enter the number of value '")
...
if number_of_peoples_1 > number_of_peoples_2 and number_of_peoples_1 > number_of_peoples_3:
    ...
    print (f"{number_of_peoples_2} This number is the largest on the list")
else: print ("Error: control the number of peoples")

average_value = float (number_of_peoples_1 + number_of_peoples_2 + number_of_peoples_3) / 3
