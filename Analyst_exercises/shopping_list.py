#Esercizio: Scrivi un programma che gestisce una lista della spesa.
#Il programma deve permettere all'utente di aggiungere articoli alla lista, visualizzare la lista corrente
#e rimuovere articoli dalla lista.

def inserisci_articolo() -> str: # type: ignore
...
def aggiungi_articolo(articolo: str, lista_della_spesa: list[str]) -> list[str]: # type: ignore
...
def rimuovi_articolo(articolo: str, lista_della_spesa: list[str]) -> list[str] | str: # type: ignore
...
def main():
    ...
    for i in range(3):
        ...
        lista_della_spesa = aggiungi_articolo(nuovo_articolo, lista_della_spesa) # type: ignore
