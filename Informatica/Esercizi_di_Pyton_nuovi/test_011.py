...
def test_first_course_attributes():
    ...
    assert first_course.pasta_type == "Spaghetti"
    assert first_course.sauce == "Carbonara"

def test_main_course_attributes():
    ...
    assert main_course.meat_type == "Beef"
    assert main_course.cooking_level == "Medium"
...
def test_dessert_attributes():
    ...
    assert dessert.dessert_type == "Dessert"
...
def test_check_ingredients():
    ...
    recipes = [first_course, main_course, dessert]
