...
#Istruzioni
#Definisci una classe chiamata Casa con gli attributi di istanza indirizzo e proprietario.
...
#Aggiungi un attributo di istanza nella classe Casa per mantenere una lista di istanze di Stanza associate.
#Implementa un metodo nella classe Casa per aggiungere una Stanza alla sua collezione.
#Crea un'istanza di Casa e aggiungi diverse istanze di Stanza alla sua collezione.
#Verifica che la Casa contenga correttamente tutte le Stanza aggiunte.
#Esempio di Utilizzo
