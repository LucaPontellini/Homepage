...
#Obiettivo
#Creare una classe chiamata Veicolo che utilizzi attributi e metodi di classe per tenere traccia del numero totale di veicoli creati.
#La classe deve avere un attributo di classe numero_veicoli e metodi di classe per accedere e modificare questo attributo.
...
motion1 = Vehicle("Motion", "Honda")  # Corretto qui
