...
-- Tipology
INSERT INTO Tipology (Id_tipologia, Nome_tipologia, Descrizione) VALUES
(1, 'Monofloral', 'Miele prodotto prevalentemente da un unico fiore'),
(2, 'Polyfloral', 'Miele di millefiori, raccolto da più specie floreali'),
(3, 'Honeydew', 'Miele prodotto a partire dal melato (secrezioni di insetti)');
...
SELECT * FROM Apiary WHERE Regione = 'Lombardia'; -- Nessun risultato previsto
...
SELECT * FROM Production WHERE Codice_apiario = 'A001'; -- Nessun risultato previsto
SELECT * FROM Production WHERE Id_miele = 3 AND Anno = 2023; -- Nessun risultato previsto