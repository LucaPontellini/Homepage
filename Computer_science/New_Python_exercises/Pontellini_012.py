...
class Engine:
    ...
    def associate_car(self, car) -> None:
        self.car = car
        car.engine = self
...
print(f"{car1.brand} {car1.model} has the engine: {car1.engine.serial_number}") # type: ignore
print(f"The engine {engine1.serial_number} belongs to: {engine1.car.brand} {engine1.car.model}") # type: ignore

# Fiat 500 has the engine: ENG123456
# The engine ENG123456 belongs to: Fiat 500